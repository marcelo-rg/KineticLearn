...
class Net(nn.Module):
    def __init__(self):
        ...
        T.nn.init.xavier_uniform(self.hid1.weight)
        T.nn.init.xavier_uniform(self.hid2.weight)
...
k_matrix = full_dataset.y_data.detach().numpy() # (m,n) m number of examples, n number of variables
# Get densities data
densities = full_dataset.x_data.detach().numpy()
